...
async function readAndParseInfo(genDataDir, file, pers) {
    ...
    // let rdfStream = fs.createReadStream(genDataDir+file);
    // let friendInfo = await parseFriendInfo(pers, rdfStream);
...
async function readIntoStore(filepath) {
    const parser = new N3.Parser({ blankNodePrefix: '' });  // See https://github.com/rdfjs/N3.js/issues/183
    ...
    //     let quads = parser.parse(line);
    //     // if (line.includes('b1_knows00000000000000004865')) {
    //     //     console.log("Target found:", line, quads);
    //     // }
